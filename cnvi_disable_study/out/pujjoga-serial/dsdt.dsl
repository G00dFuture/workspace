 ...
 *
 * Disassembly of /build/nissa/tmp/portage/sys-boot/coreboot-9999/work/build/out/pujjoga-serial/dsdt.aml
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00005B30 (23344)
 *     Revision         0x02
 *     Checksum         0x2E
 *     OEM ID           "COREv4"
    ...
    Scope (_SB)
    {
        ...
        Device (PERC)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                CreateQWordField (RBUF, \_SB.PERC._CRS._Y01._MIN, MIN1)  // _MIN: Minimum Base Address
                CreateQWordField (RBUF, \_SB.PERC._CRS._Y01._MAX, MAX1)  // _MAX: Maximum Base Address
                CreateQWordField (RBUF, \_SB.PERC._CRS._Y01._LEN, LEN1)  // _LEN: Length
                MIN1 = 0xC0000000
    ...
    Scope (_SB)
    {
        ...
        Device (PCI0)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                CreateDWordField (MCRS, \_SB.PCI0._CRS._Y02._MIN, PMIN)  // _MIN: Minimum Base Address
                CreateDWordField (MCRS, \_SB.PCI0._CRS._Y02._MAX, PMAX)  // _MAX: Maximum Base Address
                CreateDWordField (MCRS, \_SB.PCI0._CRS._Y02._LEN, PLEN)  // _LEN: Length
                PMIN = (^MCHC.TLUD & 0xFFF00000)
                PLEN = ((PMAX - PMIN) + One)
                If ((A4GS == Zero))
                {
                    CreateQWordField (MCRS, \_SB.PCI0._CRS._Y03._LEN, MSEN)  // _LEN: Length
                    MSEN = Zero
                }
                Else
                {
                    CreateQWordField (MCRS, \_SB.PCI0._CRS._Y03._MIN, MMIN)  // _MIN: Minimum Base Address
                    CreateQWordField (MCRS, \_SB.PCI0._CRS._Y03._MAX, MMAX)  // _MAX: Maximum Base Address
                    CreateQWordField (MCRS, \_SB.PCI0._CRS._Y03._LEN, MLEN)  // _LEN: Length
            ...
            Method (GMHB, 0, Serialized)
            {
                ...
                Debug = Concatenate ("GMHB: ", ToHexString (Local0))
                Return (Local0)
            }
            ...
            Device (PDRC)
            {
                ...
                Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
                {
                    ...
                    CreateDWordField (BUF0, \_SB.PCI0.PDRC._CRS._Y04._BAS, MBR0)  // _BAS: Base Address
                    MBR0 = GMHB ()
                    CreateDWordField (BUF0, \_SB.PCI0.PDRC._CRS._Y05._BAS, DBR0)  // _BAS: Base Address
                    DBR0 = GDMB ()
                    CreateDWordField (BUF0, \_SB.PCI0.PDRC._CRS._Y06._BAS, EBR0)  // _BAS: Base Address
                    EBR0 = GEPB ()
        ...
        Device (EC0)
        {
            ...
            Device (CREC)
            {
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (RBUF) /* \_SB_.PCI0.LPCB.EC0_.CREC._CRS.RBUF */
                }
